        ...
        <div>
            <div className="movies-card">
                <div className="movies-card__items">
                    ...
                    <button onClick = {handleDelSaveMovies}  className="movies-card__button"><img className="movies-card__icon" src={savedMovies}  alt="Здесь должна быть картинка"/></button>
                </div>
